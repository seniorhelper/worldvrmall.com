...
export class WVM {
  ...
  static get SECRETS() { return [
    ...
    ['wink', '👁️', 'The Watchtower', 'Out on the skyline, one tower is looking right at you. Tap it.'], ['scholar', '🏙️', 'Skyline Scholar', 'Some towers on the horizon are copies of famous real ones. Tap five of them.'], ['loft', '🚪', 'The Sky Loft', 'The city wall around the island is not all wall. Somewhere out east, past the park, one tower has a front door. Find the design board inside and furnish a room.'], ['orbit', '🚀', 'The Orbit Deck', 'The penthouse has two elevators. One of them does not stop at the roof.'], ['pigeon', '🕊️', 'The White Pigeon', 'In the room of the man who lit the world, someone he loved is still keeping watch. Look up.']]; }
